...
\svnidlong
{$HeadURL: svn+ssh://ruckdeschel@svn.r-forge.r-project.org/svnroot/distr/pkg/distrDoc/inst/doc/distr.Rnw $}
{$LastChangedDate: 2009-11-01 11:10:10 +0100 (So, 01 Nov 2009) $}
{$LastChangedRevision: 623 $}
{$LastChangedBy: stamats $}
...
\href{mailto:Nataliya.Horbenko@itwm.fraunhofer.de}{Nataliya Horbenko}. 
